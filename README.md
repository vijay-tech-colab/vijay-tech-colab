...
## 💻 Full-Stack TypeScript Developer | MERN | Modern Web Architect  

🚀 Passionate **Full-Stack Developer** specializing in **scalable, type-safe, production-ready web applications**.  
🎯 Strong foundation in **MERN Stack** with hands-on experience in **modern TypeScript ecosystems**.  
💡 Focused on **clean architecture, performance optimization, and developer experience**.  
🔍 Actively building with **Next.js, TypeScript, NestJS, Redis, RabbitMQ & TanStack ecosystem**.
...
![TanStack Table](https://img.shields.io/badge/-TanStack_Table-2563EB?style=for-the-badge&logoColor=white)
...
### ⚙️ Messaging, Caching & Infrastructure
...
- 🐇 **Async Systems**: RabbitMQ (queues, workers)  
...
💡 *Let’s build scalable, clean and impactful software together.*
